...
| M2 | Adoption scenario (app engine, committed seed 11, 4000 draws, no drift): per case, error dollars zeroed when any AGENCY slot is in the class; anchor = official FY2025 × (1 − class share); FY2025 stays locked, adoption flows only through the simulated FY2026 measurement and its election/delay math. Summed expected FY2028 bills across all 53: $7.671B/yr baseline → $7.516B strict / $6.234B broad. Strict removes $232M/yr in error dollars (K1) but only ≈$155M in expected bills — the schedule prices tiers, not points | app/public/app.js adoptStats/adoptDraws; headless replication 2026-08-12 |
| M3 | Exemplars (same engine): CO official 10.09%, centers 9.347% strict / 9.019% broad, expected FY2028 bill $158.9M → $137.3M / $127.6M (saving $21.6M–$31.3M/yr), pWin 52.5% → 80.4% / 88.3%. NY 13.18%: strict share exactly 0 (no strict-class dollars coded); broad share 17.48%, center 10.876% (still 15% tier), baseline pDelay26 41.7% → 0.45%, expected FY2028 bill RISES $629.9M → $1,015.7M — the delay-lottery nonmonotonicity. GA 15.21% (delay25 met, FY2028 = $0 both ways): baseline pDelay26 98.1% → 73.7% strict / 0.5% broad; expected FY2029 bill $8.7M → $122.0M / $452.4M; deferred bills key to FY2027, outside the simulated horizon | app/public/engine_scenario_data.json shares; headless replication 2026-08-12 |
