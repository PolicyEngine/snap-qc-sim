    ...
    lines.extend(
        [
            ...
            (
                ...
                "dollar factors, and matched dollar-rate validation. The browser "
                "scenario consumer is live: `app.js` serves the SMD model scenario "
                "as its single policy lever from `model_scenarios.json` (adoption "
                "endpoints, paired-bootstrap intervals, level-gate metadata), "
                "verifies the base-model SHA-256 pin, and disables the seven "
                "level-gated jurisdictions; the accounting-bound levers are "
                "removed. Self-employment, heat-and-eat, and BBCE scenarios are "
